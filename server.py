...
#       Copyright 2021 Andrew Yu <andrew@andrewyu.org>
#
...
class User(object):
    ...
    def handle_VERSION(self, recv):
        ...
        self.send_numeric(351, "%s. %s :http://github.com/andrewrunxiyu/wechatircd" %
