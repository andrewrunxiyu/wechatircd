...
#       Copyright 2021 Andrew Yu (AndrewYu) <andrew@andrewyu.org>
#
...
def load_configuration(config_path=None):
    ...
    config = configparser.ConfigParser(
        ...
        defaults={
            ...
            'bind_host': '',
            'bind_port': 6667,
            'motd': 'Welcome to WeChatIRCd, the WeChat to IRC bouncer daemon.',
            'ping_timeout': 250.
        },
        interpolation=None,
    )
...
class User(object):
    ...
    def welcome(self):
        ...
        self.send_numeric(2, ":Your host is %s, running WeChatIRCd" % (
            self.server.hostname))
        self.send_numeric(3, ":This server was created %s" %
                          self.server.creationtime)
        self.send_numeric(4, "%s WeChatIRCd  bov" %
                          (self.server.hostname))
    ...
    def handle_VERSION(self, recv):
        ...
        self.send_numeric(351, "WeChatIRCd. %s :http://github.com/andrewrunxiyu/wechatircd" %
                          (self.server.hostname))
